...
The benchmark runs on a single Intel B60 XPU using Qwen3-8B (vLLM `v0.22.1rc1`), comparing a VRAM-only configuration against the vLLM native `OffloadingConnector` with a 20 GiB CPU RAM tier.
